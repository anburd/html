...
$experience = [
    [
        'postCompany'=> 'типа Front-End Developer',
        'dateFrom' => 'Янв. 2015',
        'dateTo' => 'Current',
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience[$i]["postCompany"];?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]["dateFrom"];?> - 
